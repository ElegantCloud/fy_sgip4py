...
class TestSGIPServer(unittest.TestCase):
    ...
    def test_Business(self):
        ...
        header = sgip.SGIPHeader(sgip.SGIPHeader.size() + bindMsg.size(), sgip.SGIPBind.ID)
        ...
        header = sgip.SGIPHeader(sgip.SGIPHeader.size() + unbindMsg.size(), sgip.SGIPUnbind.ID)
